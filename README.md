...
NURIDOCU es un repositorio en crecimiento, vamos actualizando el contenido y añadiendo nuevos cursos constantemente.

### :white_check_mark: Cursos disponibles

- [Comandos básicos de Linux](clases-particulares/linux/README.md)
- [MYSQL de 0 a ninja](clases-particulares/mysql/README.md)
- [PostgreSQL de 0 a ninja](clases-particulares/postgresql/README.md)
- [Comandos básicos CMD de Windows](clases-particulares/windows/README.md)

### :soon: Proximamente

- [Diseño de bases de datos]()
- [Comandos bśicos POWERSHELL]()
- [Markdown like a pro]()
...
Genial, si llegas hasta aquí es que te has propuesto empezar un curso o por lo menos lo estás valorando. ¡Sigue así! :blush:

Los cursos no tienen fecha de inicio ni final, puedes realizarlos cuando quieras y durante el tiempo que necesites.
¡Estamos abiertos 24/7 los 365 días!

Una vez que entres en el curso que quieras vas a encontrar un README de introducción.
En ese README vas a encontrar una breve introducción, cursos sugeridos, un 'roadmap' sobre como recomendamos seguir el curso si no tienes experiencia previa, información que puede serte útil para contactar con nosotros o encontrar las soluciones a los ejercicios y algunos enlaces de interés.
...
Todos los cursos cuentan con unos ejercicios de nivel. Nosotros recomendamos realizarlos al inicio para que puedas autovalorar que nivel tienes y desde donde quires comenzar.
También recomendamos iniciar los cursos desde el principio ya que, aun que se pueden seguir desde cualquier punto, es importante repasar conocimientos que ya sabemos.

Si crees que partes desde 0 puedes seguir el 'roadmap' propuesto en cada inicio de curso y realizar las actividades de nivel al final o a mediados de curso para que puedas valorar tu progreso.
...
Para que podamos ayudarte es necesario que el email que nos envies cumpla estos requisitos:

- Nos encantaría conocerte, ¡presentate! :smile:
- Sé amable, recuerda que es un servicio gratuito.
- **NO ATENDEMOS DUDAS URGENTES** el experto te atenderá lo antes posible.
- En el asunto indica que es una duda de la siguente forma: [DUDA]
  ejemplo de asunto: "[DUDA] no entiendo las subconsultas en MYSQL"
- Adjunta o dinos el ejercicio o duda en la que necesitas ayuda
- Error que ha aparacido o que no sabes resolver, puedes enviarnos capturas o "copy/paste" del error.
- Material que necesitaremos para replicar el error
  - ¿Qué pasos has seguido hasta el error?
  - ¿Cúal es tu configuración?
  - En caso de haber añadido material extra, ¿que material has añadido?

>:pencil: **NOTA** cuanta más información nos dés sobre el problema, antes y de mejor forma podremos resoverlo.
>:green_heart: danos feedback sobre las correcciones, nos ayuda a mejorar y poder ofrecer mejores cursos.

Cabe destacar que el uso de ese buzón es exclusivo para estos cursos, por lo que cualquier tema no relacionado no podremos tratarlo. (aunque si nos sugieres un nuevo curso sobre ese tema, podremos tratar tus dudas :wink: )

## ¿Cómo corrijo los ejercicios?

Guay, veo que cada vez tienes más interés en los cursos. :sunglasses:

Los ejercicios propuestos los puedes corregir de varias formas:

- **Comparando tus respuestas con nuestras soluciones propuestas.**
...
Cabe destacar que el uso de ese buzón es exclusivo para estos cursos, por lo que cualquier tema no relacionado no podremos tratarlo.
