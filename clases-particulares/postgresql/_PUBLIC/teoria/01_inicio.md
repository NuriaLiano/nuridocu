...
- **Vistas**: es una tabla virtual que se crea a partir de una consulta y puede ser utilizada para acceder a los datos de una o varias tablas de forma simplificada y eficiente.
...
1. Conexión a la base de datos
   ``psql -U usuario -d nombre_de_la_base_de_datos``
